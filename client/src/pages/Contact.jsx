        ...
        <div className="bg-[#F8F4EE] min-h-screen animate-fadeIn">
            ...
            <section className="pt-36 pb-20 px-6 text-center">
                ...
                <p className="max-w-3xl mx-auto text-xl text-black/70">
                    Whether you are interested in attending an experience,
                    partnering with us, bringing a programme to your school
                    or organisation, or simply learning more about Zed Speak,
                        ...
                        <form className="space-y-5">
                            ...
                            <div>
                                ...
                                <select
                                    required
                                    defaultValue=""
                                    className="w-full border border-gray-300 rounded-2xl px-5 py-4 outline-none focus:border-[#7A4B2A] bg-white"
                                >
